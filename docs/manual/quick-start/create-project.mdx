...
JSAR allows you to initialize a project in various ways, including:

- Locally creating a project using npm commands.
- Creating a GitHub project from a template.
