...
| API | 状态 | 备注 |
| --- | --- | --- |
| `setTimeout` | 已实现 | 由 JSAR 实现 |
| `clearTimeout` | 已实现 | 由 JSAR 实现 |
| `setInterval` | 已实现 | 由 JSAR 实现 |
| `clearInterval` | 已实现 | 由 JSAR 实现 |
...
| API | 状态 | 备注 |
| --- | --- | --- |
| `AudioContext` | 已实现 | 由 JSAR 实现 |
| `AudioBuffer` | 已实现 | 由 JSAR 实现 |
| `AudioBufferSourceNode` | 已实现 | 由 JSAR 实现 |
| `AudioDestinationNode` | 已实现 | 由 JSAR 实现 |
| `AudioListener` | 已实现 | 由 JSAR 实现 |
| `AudioParam` | 已实现 | 由 JSAR 实现 |
| `AudioWorklet` | 未实现 |  |
| `AudioWorkletNode` | 未实现 |  |
| `BaseAudioContext` | 已实现 | 由 JSAR 实现 |
