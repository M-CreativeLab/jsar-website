          ...
          >
            <li style={listItemStyle}>
              <Space>
                ...
                <Typography.Text>支持 <code>Web-standard APIs</code>、<code>TypeScript</code> 和 <code>Babylon.js</code></Typography.Text>
              </Space>
            </li>
            <li style={listItemStyle}>
              <Space>
                <CheckCircleOutlined style={{ color: '#389e0d' }} />
                <Typography.Text>空间运行安全，空间组件运行在空间隔离框架中，保证在空间中互不干扰</Typography.Text>
              </Space>
            </li>
            <li style={listItemStyle}>
              <Space>
                <CheckCircleOutlined style={{ color: '#389e0d' }} />
                <Typography.Text>通过应用层与渲染层代码逻辑分离，实现多实例渲染的高性能</Typography.Text>
              </Space>
            </li>
          </ul>
